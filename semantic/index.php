...
<html lang="en">
    <head>
        ...
        <meta name="description" content="IMA - SEMANTIC FRAMEWORK FRONT-END -">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta http-equiv="X-UA-Compatible" content="ie=edge">
        <title>IMA - SEMANTIC UI FRAMEWORK FRONT-END -</title>
    ...
    <body>
        <nav class="ui menu">
            <a class="header item" href="#">IMA - BALNEABILIDADE</a>
        </nav>
        <main class="ui container" role="main">&nbsp;</main>
